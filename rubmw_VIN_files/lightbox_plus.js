...
Lightbox.prototype = {
	...
	_setOpacity : function(elem, alpha)
	{
		if (Spica.Browser.isWinIE)
			...
			elem.style.opacity = (alpha / 10)*1.5;
	},
	_close_box : function()
	{
		var self = this;
...
Spica.Event.run(function() { 
	var lightbox = new Lightbox({
		loadingimg:'/scripts/lightbox/loading.gif',
		expandimg:'/scripts/lightbox/expand.gif',
		shrinkimg:'/scripts/lightbox/shrink.gif',
		blankimg:'/scripts/lightbox/blank.gif',
		previmg:'/scripts/lightbox/prev.gif',
		nextimg:'/scripts/lightbox/next.gif',
		closeimg:'/scripts/lightbox/close.gif',
		effectimg:'/scripts/lightbox/zzoop.gif',
		effectpos:{x:-40,y:-20},
